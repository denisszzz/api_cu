...
/**
 * @ODM\Document(collection="collections_podcast5ef42bcf17823")
...
class Podcast
{
    ...
    public function toArray(): array
    {
        return [
            ...
            "body" => $this->getBody(),
            "podcast_iframe" => $this->getPodcastIframe(),
            "time" => $this->getTime(),
    ...
    private function getPodcastIframe()
    {
        return $this->podcast_iframe;
    }
