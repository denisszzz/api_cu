 ...
 */
class ApiModelLongreadHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
        ...
        if (isset($data['rubric']) || (! empty($this->class->fieldMappings['rubric']['nullable']) && array_key_exists('rubric', $data))) {
            ...
            if ($return !== null) {
                if ($this->class->fieldMappings['rubric']['storeAs'] !== ClassMetadata::REFERENCE_STORE_AS_ID && ! is_array($return)) {
                    throw HydratorException::associationTypeMismatch('Api\Model\Longread', 'rubric', 'array', gettype($return));
                }
