 ...
 */
class ApiModelPodcastHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate(object $document, array $data, array $hints = array()): array
    {
        ...
        /** @Field(type="string") */
        if (isset($data['podcast_iframe']) || (! empty($this->class->fieldMappings['podcast_iframe']['nullable']) && array_key_exists('podcast_iframe', $data))) {
            $value = $data['podcast_iframe'];
            if ($value !== null) {
                $typeIdentifier = $this->class->fieldMappings['podcast_iframe']['type'];
                $return = (string) $value;
            } else {
                $return = null;
            }
            $this->class->reflFields['podcast_iframe']->setValue($document, $return);
            $hydratedData['podcast_iframe'] = $return;
        }
        ...
        if (isset($data['time']) || (! empty($this->class->fieldMappings['time']['nullable']) && array_key_exists('time', $data))) {
            $value = $data['time'];
            if ($value !== null) {
                $typeIdentifier = $this->class->fieldMappings['time']['type'];
                $return = (string) $value;
            } else {
                $return = null;
            }
        ...
        if (isset($data['podcasts']) || (! empty($this->class->fieldMappings['podcasts']['nullable']) && array_key_exists('podcasts', $data))) {
            $value = $data['podcasts'];
            if ($value !== null) {
                $typeIdentifier = $this->class->fieldMappings['podcasts']['type'];
                $return = $value;
            } else {
                $return = null;
            }
            $this->class->reflFields['podcasts']->setValue($document, $return);
            $hydratedData['podcasts'] = $return;
        }
        ...
        if (isset($data['rubric']) || (! empty($this->class->fieldMappings['rubric']['nullable']) && array_key_exists('rubric', $data))) {
            ...
            if ($return !== null) {
                if ($this->class->fieldMappings['rubric']['storeAs'] !== ClassMetadata::REFERENCE_STORE_AS_ID && ! is_array($return)) {
                    throw HydratorException::associationTypeMismatch('Api\Model\Podcast', 'rubric', 'array', gettype($return));
                }
