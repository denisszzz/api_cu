 ...
 * Repository.
 */
class LongreadRepository extends DocumentRepository
{
    ...
    public function __construct(DocumentManager $connection)
    {
        ...
        parent::__construct($connection, $this->connection->getUnitOfWork(), $this->connection->getClassMetadata(Longread::class));
    }
