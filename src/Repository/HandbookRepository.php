 ...
 * Repository.
 */
class HandbookRepository extends DocumentRepository
{
    ...
    public function __construct(DocumentManager $connection)
    {
        ...
        parent::__construct($connection, $this->connection->getUnitOfWork(), $this->connection->getClassMetadata(Handbook::class));
    }
